...
const Footer = ({className}) => {
  ...
  <div className="section-container">
    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 mb-12">
      ...
      <div className="space-y-5">
        ...
        <div className="flex space-x-4">
          {[FaFacebook, FaInstagram, FaTwitter, FaLinkedin].map((Icon, i) => (
            <a key={i} href="#" className="text-secondary dark:text-gray-400 hover:text-main-green transition-colors duration-200">
              <Icon size={18} />
            </a>
          ))}
        </div>
      ...
      {/* Contact Info */}
      <div>
        <h3 className="text-white dark:text-white font-primary text-lg mb-4 font-semibold">Contact Us</h3>
        <ul className="space-y-3">
          ...
          <li className="flex items-center gap-3">
            ...
            <span className="text-secondary dark:text-gray-400 font-secondary text-sm">+234 708 731 7988</span>
          </li>
          <li className="flex items-center gap-3">
            <FaEnvelope className="text-white" size={14} />
            <span className="text-secondary dark:text-gray-400 font-secondary text-sm">info@yourdomain.com</span>
          </li>
        </ul>
      </div>
    </div>
