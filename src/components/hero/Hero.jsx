  ...
  return (
    ...
    <section className="section-container  mx-auto section-container bg-bg-green h-screen xs:h-[640px] md:h-[510px] lg:h-[490px] md:items-center justify-center flex items-start  gap-4 flex-col-reverse md:flex-row ">
      <div className="flex-1 flex flex-col gap-y-5">
        ...
        <p className="leading-[29px] text-center md:text-left">
        ...
        <div className="flex items-center justify-center md:justify-start  gap-x-4">
          <Link to={`${isAuthenticated ? getLoggedInUserPath(user) : paths.register}`} className="btn btn-cta btn-sm">Get Started</Link>
      ...
      <div className="md:flex-1 w-full">
        <img
          src="./r1.png"
          alt=""
          className=" w-[300px] mx-auto md:w-[450px] ml-auto pt-[20px] object-cover"
        />
      </div>
    </section>
  );
