...
const PropertyOwnerContact = ({ property }) => {
  ...
  return (
    <div className={`flex items-center justify-between gap-3`}>
      <a
        href={`mailto:${property.owner.email}?subject=Regarding ${encodeURIComponent(
          property.title
        )}&body=Hello, I'm interested in your property at ${encodeURIComponent(property.location)}`}
