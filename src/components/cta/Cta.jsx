    ...
    <section className="section-container bg-green-gradient  py-12 md:py-24 text-white">
      <div className="max-w-4xl mx-auto text-center px-4">
        ...
        <p className="text-xl md:text-2xl mb-8 leading-relaxed">
          Join <span className="font-semibold">10,000+</span> satisfied users who found their
          perfect home through our platform. List your property or start searching today - it takes
          just 30 seconds!
        </p>
