...
const SearchAndFilterBar = ({
  ...
  return (
    <div
      className={` bg-white dark:bg-gray-900  shadow-sm text-sm space-y-4 lg:flex flex-col h-full overflow-y-auto sticky top-20 p-4 ${className}  `}
    >
      {/* Search Input */}
        ...
        <>
          ...
          <CollapsableBox title="Advanced" className="!p-0 !shadow-none !border-none pr-1">
            <div className="pt-4 border-t border-gray-200 dark:border-gray-700 space-y-4 max-h-[100px] overflow-y-auto">
              {/* Sort By */}
              <div>
                <label className="block text-[13px] font-medium text-primary-text dark:text-white mb-2">
                  Sort By
                </label>
                <select
