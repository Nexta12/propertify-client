      ...
      <AnimatePresence>
        {open && (
          <Motion.div
            ...
            className="absolute -right-5 md:right-0 mt-2 w-80 md:w-96 bg-white shadow-lg rounded-xl overflow-hidden border z-50"
          >
            ...
            <div className="max-h-60 overflow-y-auto">
              {notifications?.length > 0 ? (
                notifications.map((notif, index) => (
                  <div
                    key={notif._id || index}
                    className={`relative flex px-4 py-3 hover:bg-gray-100 transition-all border-b last:border-none ${
                      !notif.isSeen ? "bg-gray-50" : ""
                    }`}
                  >
                    ...
                    <div className="relative">
                      ...
                      {menuOpenId === notif._id && (
                        <div className="absolute right-0 top-6 bg-white shadow-md border rounded w-28 z-50">
                          <button
