...
const AdminStats = () => {
  ...
  useEffect(() => {
    const fetchAdminStats = async () => {
      try {
        const [resUsers, resPosts, resInqu, resContacts, resTickets, resRevenue] =
          await Promise.all([
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="border border-gray-200 dark:border-gray-800 rounded-lg p-4 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-750 transition-colors">
          <div className="flex items-center mb-4">
            ...
            <h3 className="font-semibold text-gray-700 dark:text-gray-200">Users</h3>
          </div>
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              {metricsData?.users?.data?.roleTotals &&
                Object.entries(metricsData.users.data.roleTotals).map(([role, count]) => (
                  <p key={role} className="font-medium text-gray-600 dark:text-gray-300">
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 pt-3">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">
                <span className="font-medium">Verified:</span> {metricsData?.users?.data?.verified}
              </p>
              <p className="text-sm text-gray-600 dark:text-gray-300">
        ...
        <div className="border border-gray-200 dark:border-gray-800 rounded-lg p-4 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-750 transition-colors">
          <div className="flex items-center mb-4">
            ...
            <h3 className="font-semibold text-gray-700 dark:text-gray-200">Posts</h3>
          </div>
          <div className="space-y-4">
            <div>
              <p className="text-2xl font-bold text-gray-800 dark:text-white">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              {metricsData?.posts?.data?.postsByStatus &&
                Object.entries(metricsData.posts.data.postsByStatus).map(([status, count]) => (
        ...
        <div className="border border-gray-200 dark:border-gray-800 rounded-lg p-4 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-750 transition-colors">
          <div className="flex items-center mb-4">
            ...
            <h3 className="font-semibold text-gray-700 dark:text-gray-200">Contacts</h3>
          </div>
          <div className="space-y-4">
            <div>
              <p className="text-2xl font-bold text-gray-800 dark:text-white">
        ...
        <div className="border border-gray-200 dark:border-gray-800 rounded-lg p-4 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-750 transition-colors">
          <div className="flex items-center mb-4">
            ...
            <h3 className="font-semibold text-gray-700 dark:text-gray-200">Inquiries</h3>
          </div>
          <div className="space-y-4">
            <div>
              <p className="text-2xl font-bold text-gray-800 dark:text-white">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                {metricsData?.inquiries?.data?.thisWeekContactFormInquiries.toLocaleString()} new
                this week
              </p>
            </div>
          </div>
        ...
        <div className="border border-gray-200 dark:border-gray-800 rounded-lg p-4 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-750 transition-colors">
          <div className="flex items-center mb-4">
            ...
            <h3 className="font-semibold text-gray-700 dark:text-gray-200">Support</h3>
          </div>
          <div className="space-y-4">
            <div>
              <p className="text-2xl font-bold text-gray-800 dark:text-white">
            ...
            <div className="grid grid-cols-2 gap-2 text-sm">
              {metricsData?.tickets?.data?.ticketsByStatus &&
                Object.entries(metricsData.tickets.data.ticketsByStatus).map(([status, count]) => (
                  <p key={status} className="font-medium text-gray-600 dark:text-gray-300">
                    {status.charAt(0).toUpperCase() + status.slice(1)}:{" "}
                    <span className="text-gray-500 dark:text-gray-400">{count}</span>
                  </p>
