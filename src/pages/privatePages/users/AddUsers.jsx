    ...
    <div className=" min-h-screen bg-gray-50 flex flex-col pb-8">
      <div className=" lg:px-8 flex-grow">
        <div className="w-full mx-auto">
          ...
          {/* Main Card */}
          <div className="bg-white rounded-xl shadow-md relative p-4 py-8 lg:px-8">
            
            <div className="flex justify-end mb-6">
              <button
                type="button"
                onClick={handleImportClick}
                className="px-4 py-2 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200 flex items-center"
