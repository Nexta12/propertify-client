...
const fetchUserData = async () => {
  ...
  return (
    <>
      <HandleGoBackBtn/>
   <div className="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-md dark:shadow-lg">
  {/* Cover Image */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
        {userProperties.map((property) => (
          <Link
            ...
            key={property._id}
            className="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden hover:shadow transition bg-white dark:bg-gray-800"
          >
