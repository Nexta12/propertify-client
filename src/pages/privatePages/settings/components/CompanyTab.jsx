  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const sanitizedFormData = {
        ...
        ...(typeof companyData.companyLogo?.url === "string" && {
      ...
      <form onSubmit={handleSubmit}>
        <div className="space-y-8">
          <div className="flex items-center gap-6">
            <div className="relative">
              <div className="w-24 h-24 rounded-xl bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center overflow-hidden border border-gray-200">
                {companyData.companyLogo ? (
                  <img
                    src={getImageSrc(companyData.companyLogo?.url || companyData.companyLogo)}
                    alt="Company Logo"
            ...
            <FileUpload
              ref={logoRef}
              value={companyData.companyLogo?.url || companyData.companyLogo}
