  ...
  const confirmDelete = async () => {
    ...
    try {
      if (itemToDelete) {
        ...
        await apiClient.put(`${endpoints.UpdateUser}/${user?.slug}`, {
          ...
          <div className="relative mb-16">
            ...
            <div className="absolute -bottom-12 left-6">
              <div className="relative">
                <div className="w-24 h-24 border-4 border-white bg-gradient-to-br from-gray-100 to-gray-200 rounded-full flex items-center justify-center overflow-hidden">
